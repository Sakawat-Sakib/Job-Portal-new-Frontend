    ...
    <div className="text-center text-[#757575]">
      <div className="flex flex-col gap-5 my-10">
        <div className="text-center mx-auto">
          <div className="text-white px-4 py-2 rounded-full bg-black/50 font-semibold">
            No. 1 Job Searching Site
          </div>
        </div>
        <h1 className="text-5xl font-bold">
          <span className="text-[#FF7043]">Discover</span>, Apply{" "}
          <span className="text-[#FF7043]">&</span> <br /> Land your Perfect
          Job
        </h1>
        <p>
