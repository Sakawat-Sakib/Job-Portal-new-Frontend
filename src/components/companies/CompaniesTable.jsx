    ...
    <>
      <div className="flex items-center justify-between my-5">
        ...
        <CreateUpdateCompany
          ...
          user={user}
        >
          <span className="bg-[#FF7043] hover:bg-[#FF7043] p-2 cursor-pointer rounded text-white">
            Create Company
          </span>
        </CreateUpdateCompany>
      </div>
            ...
            ? companies?.map((company) => (
                <TableRow key={company.id}>
                  ...
                  <TableCell className="flex gap-2 float-end">
                    ...
                    >
                      <span className="">
                        <Edit2 className="bg-[#757575] text-white p-1 rounded-md h-7 w-7 cursor-pointer" />
                      </span>
                    </CreateUpdateCompany>
                    <DeleteCompany
                      setCompanies={setCompanies}
                    ...
                    >
                      <span className="">
                        <X className="bg-red-500 text-white p-1 rounded-md h-7 w-7 cursor-pointer" />
                      </span>
                    </DeleteCompany>
                  </TableCell>
                </TableRow>
